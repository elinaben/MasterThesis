...
```{r fig-published-context, out.width="49%", fig.show="hold"}
...
```{r fig-tau-isoforms-structure, out.width="49%", fig.show="hold",
    fig.cap=c("Tau isoforms (Alz journal).", "Tau protein structure (ScienceDirect).")}
knitr::include_graphics("figs/Isoforms_of_Tau_alz_journal.jpg")
knitr::include_graphics("figs/Tau_Structure_scidirect.jpg")
```
...
```{r fig-tau-roles, out.width="60%", fig.align="center",
    fig.cap="Sinsky, J., Pichlerova, K., & Hanes, J. (2021)."}
